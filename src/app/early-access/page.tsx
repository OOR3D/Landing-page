    ...
    <NavigationWrapper>
      <main className="min-h-screen bg-[#0a0f1a] flex flex-col items-center justify-center relative py-40">
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          >
            OOR3D™ is designed to make 3D creation faster, easier, and more accessible across platforms like IMVU, Second Life, Sims 4, and more. You're getting in at the ground floor.
          </motion.p>
