...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'OOR3D™ gives creators the power to design, customize, and launch digital wearables for IMVU, Second Life, Sims 4, and more. All without complicated 3D software.',
