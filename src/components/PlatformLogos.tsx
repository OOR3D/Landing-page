...
const platforms = [
  // Top Row
  { name: "Zepeto", src: "https://assets.oor3d.com/img/downloads/zepeto/zepeto-logo.svg", width: 60, height: 60, top: 12, left: 50, url: "https://web.zepeto.me", mobile: { top: 2, left: 50 } },
  { name: "IMVU", src: "https://assets.oor3d.com/img/downloads/imvu/imvu.webp", width: 60, height: 60, top: 18, left: 18, url: "https://imvu.com", mobile: { top: 15, left: 10 } },
  { name: "Roblox", src: "https://assets.oor3d.com/img/downloads/roblox/roblox-logo.svg", width: 60, height: 60, top: 18, left: 82, url: "https://www.roblox.com", mobile: { top: 15, left: 90 } },
  
  // Inner Mid Row
  { name: "Second Life", src: "https://assets.oor3d.com/img/downloads/secondlife/secondlife.svg", width: 140, height: 40, top: 28, left: 32, url: "https://secondlife.com", mobile: { top: 28, left: 20 } },
  { name: "Minecraft", src: "https://assets.oor3d.com/img/downloads/minecraft/minecraft.svg", width: 120, height: 40, top: 32, left: 68, url: "https://www.minecraft.net", mobile: { top: 28, left: 80 } },
  
  // Outer Mid Row
  { name: "The Sims 4", src: "https://assets.oor3d.com/img/downloads/sims4/sims-4.svg", width: 60, height: 60, top: 50, left: 12, url: "https://www.ea.com/games/the-sims/the-sims-4", mobile: { top: 72, left: 10 } },
  { name: "VRChat", src: "https://assets.oor3d.com/img/downloads/vrchat/vchat-logo.png", width: 60, height: 60, top: 50, left: 88, url: "https://vrchat.com", mobile: { top: 72, left: 90 } },
  
  // Low Row
  { name: "Inzoi", src: "https://assets.oor3d.com/img/downloads/inzoi/inzoi.svg", width: 80, height: 40, top: 72, left: 15, url: "https://playinzoi.com", mobile: { top: 85, left: 15 } },
  { name: "FiveM", src: "https://assets.oor3d.com/img/downloads/fivem/fivem.svg", width: 50, height: 50, top: 72, left: 85, url: "https://fivem.net", mobile: { top: 85, left: 85 } },
  
  // Bottom Row
  { name: "Avakin Life", src: "https://assets.oor3d.com/img/downloads/avakinlife/avakinlife.png", width: 60, height: 60, top: 88, left: 35, url: "https://avakin.com", mobile: { top: 98, left: 35 } },
  { name: "GTA 6", src: "https://assets.oor3d.com/img/downloads/gta6/gta6-logo.png", width: 80, height: 60, top: 88, left: 65, url: "https://www.rockstargames.com/gta6", mobile: { top: 98, left: 65 } },
];
              ...
              >
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      <div className="absolute inset-2 sm:inset-0 bg-[#251D3E]/40 backdrop-blur-md border border-white/10 rounded-[28px] shadow-lg group-hover:bg-[#251D3E]/60 group-hover:border-white/20 group-hover:scale-110 transition-all duration-300" />
